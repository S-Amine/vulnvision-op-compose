...
"""
        ...
        try:
            ...
            os.system('''docker exec -it base_op_server bash -c "echo \"from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('admin@admin.com', 'adminadmin')\" | python3 manage.py shell"''')
            print(f"""
